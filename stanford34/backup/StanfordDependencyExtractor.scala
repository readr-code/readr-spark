...
//
//  val DEFAULT_DEP_TYPE = "DepCollapsed"//"DepCCProcessed"
//  
...
//        ins(5).asInstanceOf[ParseAnn]))
//  }
//  
//  def run(t:TextAnn, soa:SentenceOffsetAnn, stoa:SentenceTokenOffsetAnn, toa:TokenOffsetAnn, to:TokensAnn, pa:ParseAnn):SentenceDependencyAnn = {
//
