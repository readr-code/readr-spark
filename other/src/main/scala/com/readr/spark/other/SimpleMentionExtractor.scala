...
//      requires = Array(classOf[ConstituentAnn], classOf[CoreferenceAnn], classOf[SentenceTokenOffsetAnn])) {
//
//  val properties = new Properties()
//
//  override def annotate(ins:Any*):Array[Any] = {
//    val out = run(ins(0).asInstanceOf[ConstituentAnn],
//        ins(1).asInstanceOf[CoreferenceAnn], ins(2).asInstanceOf[SentenceTokenOffsetAnn])
//    Array(out._1, out._2)
//  }
//
//  def run(ca:ConstituentAnn, cra:CoreferenceAnn, stoa:SentenceTokenOffsetAnn):(SentenceMentionAnn,MentionAnn) = {
//
